...
places = [
  {:name => 'National Gallery of Victoria', :location => '180 St Kilda Road, Melbourne.  Victoria.  3004', 
    ...
    :image_url => 'http://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/National_Gallery_of_Victoria%2C_Entrance_sign.jpg/200px-National_Gallery_of_Victoria%2C_Entrance_sign.jpg'},
  {:name => 'Flinders Street Station', :location => "Corner of Flinders and Swanston St, Melbourne.  Victoria.  3000", 
    ...
    :image_url => 'http://farm1.static.flickr.com/46/183186347_37c50ca3f8.jpg'},
  {:name => 'Federation Square', :location => 'Federation Square, Melbourne. Victoria',
    :category => Category.find_by_name('Landmark'),
    :image_url => 'http://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Fed_Square.jpg/250px-Fed_Square.jpg'},
  {:name => 'Southbank', :location => 'Southbank, Melbourne. Victoria', :category => Category.find_by_name('Landmark'),
    :image_url => 'http://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Eureka_Tower_01.jpg/250px-Eureka_Tower_01.jpg'},
  {:name => 'Southbank', :location => 'Southbank, Melbourne. Victoria', :category => Category.find_by_name('Landmark'),
    :image_url => 'http://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Eureka_Tower_01.jpg/250px-Eureka_Tower_01.jpg'},
  {:name => 'Brunswick Street', :location => 'Brunswick St, Melbourne. Victoria', :category => Category.find_by_name('Landmark'),
    :image_url => 'http://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Brunswick_Street%2C_Fitzroy%2C_Victoria%2C_Australia.jpg/200px-Brunswick_Street%2C_Fitzroy%2C_Victoria%2C_Australia.jpg'},
  {:name => 'Luna Park', :location => 'Luna Park, St Kilda, Melbourne. Victoria', :category => Category.find_by_name('Landmark'),
    :image_url => 'http://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Luna_park_melboure.jpg/270px-Luna_park_melboure.jpg'},
  ]
